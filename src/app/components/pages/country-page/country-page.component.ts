...
export class CountryPageComponent implements OnInit {
 ...
 async ngOnInit() {
    let nameTimeline = this.route.snapshot.params.country.toLowerCase();
    if (nameTimeline == "usa") {
      nameTimeline = "us";
    ...
    this.zone.runOutsideAngular(() => {
      combineLatest(
        this.mainService.getStatsByCountry(this.route.snapshot.params.country),
        this.mainService.getTimelineDataByCountry(nameTimeline)
      ).subscribe(([allData,timeLineDatas])=>{
          this.country = allData;
          this.totalCases = allData["cases"];
          this.totalDeaths = allData["deaths"];
          this.totalRecoveries = allData["recovered"];
          this.totalCritical = allData["critical"];
          this.todayCases = allData["todayCases"];
          this.todayDeaths = allData["todayDeaths"];
          this.activeCases = allData["active"];
          this.casesPer1M = allData["casesPerOneMillion"];
          this.finishedCases = this.totalDeaths + this.totalRecoveries;
          console.log(this.totalRecoveries);
          this.timeLine = timeLineDatas;
